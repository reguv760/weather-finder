	...
	render()
	{
		return (
			<div className="weather__info">
				...
				{ this.props.description && <p className="weather__key">Conditions: <br/> <WeatherIcon icon={ this.props.icon} /> <span className="weather__value"> { this.props.description }</span> </p> }
